...
typedef NS_ENUM(unsigned short, FAIcon) {
    ...
    FAIconHandshakeO = 0xf2b5,
    FAIconEnvelopeOpen = 0xf2b6,
    FAIconEnvelopeOpenO = 0xf2b7,
    FAIconLinode = 0xf2b8,
    FAIconAddressBook = 0xf2b9,
    FAIconAddressBookO = 0xf2ba,
    FAIconVcard = 0xf2bb,
    FAIconAddressCard = 0xf2bb,
    FAIconVcardO = 0xf2bc,
    FAIconAddressCardO = 0xf2bc,
    FAIconUserCircle = 0xf2bd,
    FAIconUserCircleO = 0xf2be,
    FAIconUserO = 0xf2c0,
    FAIconIdBadge = 0xf2c1,
    FAIconDriversLicense = 0xf2c2,
    FAIconIdCard = 0xf2c2,
    FAIconDriversLicenseO = 0xf2c3,
    FAIconIdCardO = 0xf2c3,
    FAIconQuora = 0xf2c4,
    FAIconFreeCodeCamp = 0xf2c5,
    FAIconTelegram = 0xf2c6,
    FAIconThermometer4 = 0xf2c7,
    FAIconThermometer = 0xf2c7,
    FAIconThermometerFull = 0xf2c7,
    FAIconThermometer3 = 0xf2c8,
    FAIconThermometerThreeQuarters = 0xf2c8,
    FAIconThermometer2 = 0xf2c9,
    FAIconThermometerHalf = 0xf2c9,
    FAIconThermometer1 = 0xf2ca,
    FAIconThermometerQuarter = 0xf2ca,
    FAIconThermometer0 = 0xf2cb,
    FAIconThermometerEmpty = 0xf2cb,
    FAIconShower = 0xf2cc,
    FAIconBathtub = 0xf2cd,
    FAIconS15 = 0xf2cd,
    FAIconBath = 0xf2cd,
    FAIconPodcast = 0xf2ce,
    FAIconWindowMaximize = 0xf2d0,
    FAIconWindowMinimize = 0xf2d1,
    FAIconWindowRestore = 0xf2d2,
    FAIconTimesRectangle = 0xf2d3,
    FAIconWindowClose = 0xf2d3,
    FAIconTimesRectangleO = 0xf2d4,
    FAIconWindowCloseO = 0xf2d4,
    FAIconBandcamp = 0xf2d5,
    FAIconGrav = 0xf2d6,
    FAIconEtsy = 0xf2d7,
    FAIconImdb = 0xf2d8,
    FAIconRavelry = 0xf2d9,
    FAIconEercast = 0xf2da,
    FAIconMicrochip = 0xf2db,
    FAIconSnowflakeO = 0xf2dc,
    FAIconSuperpowers = 0xf2dd,
    FAIconWpexplorer = 0xf2de,
    FAIconMeetup = 0xf2e0
};
